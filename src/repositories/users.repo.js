...
export function createUsersRepo() {
    ...
    return {
         ...
         * @returns {User}
         */
        create(data) { //we are creating user ids here. when a user id object is created with the email, name and the hashed password. When a new user id is made, it adds on to the last userid that was created to set the next userID automatically.
